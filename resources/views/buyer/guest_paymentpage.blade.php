...
@section('content')
                        ...
                        <div class="row margin-bottom-40">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="colmd12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <form action="{{url('guest/pay/'.$order['partnumber'].'/'.$order['quantity'].'/'.(int)($order['total_price'])*100)}}" method="POST">
                                                    {{ csrf_field() }}
                                                    <script
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 margin-top-20" style = "display:none">
                                    <a href="{{url('guest/report/'.$order['customername'].'/'.$order['partnumber'].'/'.$order['quantity'].'/'.$order['description'].'/'.$order['total_price'].'/download')}}" class="btn btn-outline    btn-xs   ">Download Receipt</a>
                                    <a href="{{url('guest/report/'.$order['customername'].'/'.$order['partnumber'].'/'.$order['quantity'].'/'.$order['description'].'/'.$order['total_price'].'/view')}}" class="btn btn-outline    btn-xs   ">View Receipt</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="fail" class="modal fade" tabindex="-1" data-width="380px">
        <div class="modal-header" style="background: #FF3C11">
